 ...
 * it with character x. Adds a terminating null byte
 * @size: the size to be initialized
 *
...
/**
 * iterate_zeroes - iterate through a string of numbers
 ...
 * @prod: the buffer to the store  the result
 ...
 * @argv: the number of arguments passed to the programm
 * @argc: an array of pointers to the arguments
 *
 * Description: if the number of arguments is incorrect
 * or one number contains non-digits, the function exits
 * with a status of 98.
 *
 * Return: Always 0
 */
