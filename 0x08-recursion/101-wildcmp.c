 ...
 * @s: a pointer to the string to find length of
 *
 ...
 * @ss_len: the max number of bytes to check in ss
 *
 * Description: Find the first occurrence of the substring ss in the
 * string s. The terminating null bytes ('\0') are not compared.
 *
 ...
 * @s1: a pointer to the string to search
 * @s2: a pointer to the second pattern
 * @wild_prev: a pointer to the previous wildcard
 *
 * Description: compare s1 and s2, where s2 may
 * contain wilcard '*' which matches any string (including the empty string)
 *
